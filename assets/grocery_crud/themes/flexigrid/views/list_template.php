...
<div
	id='list-report-error' class='report-div error'></div>
<div id='list-report-success' class='report-div success report-list'
<?php if($success_message !== null){?> style="display: block" <?php }?>>
	<?php
	...
	<?php if(!$unset_add || !$unset_export || !$unset_print){?>
		...
		<?php if(!$unset_add){?>
			<div class="tDiv2">
				<a href='<?php echo $add_url?>'
					...
					<div class="fbutton">
						<div>
							<span class="add"><?php echo $this->l('list_add'); ?> <?php echo $subject?>
							</span>
						</div>
					</div> </a>
		...
		<div class="sDiv quickSearchBox" id='quickSearchBox'>
			...
			<?php echo $this->l('list_search');?>
				: <input type="text" class="qsbsearch_fieldox search_text"
			...
			<div class="pDiv2">
				...
				<div class="pGroup">
					<span class="pcontrol"><?php echo $this->l('list_page'); ?> <input
						...
						class="crud_page"> <?php echo $this->l('list_paging_of'); ?> <span
						id='last-page-number' class="last-page-number"><?php echo ceil($total_results / $default_per_page)?>
					</span> </span>
				</div>
				<div class="btnseparator"></div>
				<div class="pGroup">
				...
				<div class="btnseparator"></div>
				<div class="pGroup">
					<span class="pPageStat"> <?php $paging_starts_from = "<span id='page-starts-from' class='page-starts-from'>1</span>"; ?>
